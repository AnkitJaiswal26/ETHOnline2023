...
<div>
    ...
    <TabPanel>
    <h1 class="text-xl font-bold text-white capitalize dark:text-white">Create Offer</h1>

<form>
    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        <div>
        <label class="text-white dark:text-gray-200" for="username">Tokens to borrow</label>
        ...
        <label class="inline-flex items-center mt-3">
                <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" /><span class="ml-2 text-white">Use NFT as collateral</span>
            </label>
</div>

<div>
        <label class="text-white dark:text-gray-200" for="username">Tokens for collateral</label>
          <div  className="relative mt-2 rounded-md shadow-sm">
        ...
        <div>
            <label class="text-white dark:text-gray-200" for="passwordConfirmation">Date of Expiry</label>
  ...
  <label for="custom-input-number" class="w-full text-white text-sm font-semibold">Number of Payments
  </label>
...
<div class="custom-number-input h-10">
  <label for="custom-input-number" class="w-full text-white text-sm font-semibold">Rate of interest
  </label>
  <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
    <button data-action="decrement" class=" bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-l cursor-pointer outline-none">
      <span class="m-auto text-2xl font-thin">−</span>
